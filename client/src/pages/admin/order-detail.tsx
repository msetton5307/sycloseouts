        ...
        {order.paymentDetails && (
          <Card>
            ...
            <CardContent className="space-y-1">
              ...
              {order.paymentDetails.routingNumber && (
                <p>Routing: {order.paymentDetails.routingNumber}</p>
              )}
              {order.paymentDetails.accountNumber && (
                <p>Account: {order.paymentDetails.accountNumber}</p>
              )}
              {order.paymentDetails.last4 && (
                <p>Card Ending: ****{order.paymentDetails.last4}</p>
              )}
            </CardContent>
          </Card>
        )}
